                                                    ...
                                                    if($hasil != "0"){
                                                        ...
                                                        while($k=mysqli_fetch_array($alternatif)){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <b><?php echo $k['alt_inisial']; ?> - <?php echo $k['alt_nama']; ?></b><br>
                                                                    <?php 
                                                                    $bobot = mysqli_query($koneksi,"select sum(kec_bobot) as total_bobot from kecocokan where kec_alternatif='$hasil'");
                                                                    $b = mysqli_fetch_assoc($bobot);
                                                                    
                                                                     ?>
                                                                     <b><?php echo $b['total_bobot']; ?> %</b>
                                                                </td>
                                                            </tr>                    
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <th width="30%">SOLUSI PENGOBATAN</th>
